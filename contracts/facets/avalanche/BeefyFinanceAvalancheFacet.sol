...
contract BeefyFinanceAvalancheFacet is ReentrancyGuardKeccak, OnlyOwnerOrInsolvent {
    ...
    **/
    function stakePngUsdcAvaxLpBeefy(uint256 amount) public onlyOwnerOrInsolvent nonReentrant noBorrowInTheSameBlock remainsSolvent {
    ...
    **/
    function stakePngUsdceAvaxLpBeefy(uint256 amount) public onlyOwnerOrInsolvent nonReentrant noBorrowInTheSameBlock remainsSolvent {
        _stakeLpBeefy(IBeefyFinance.BeefyStakingDetails({
    ...
    **/
    function stakeTjUsdcAvaxLpBeefy(uint256 amount) public onlyOwnerOrInsolvent nonReentrant noBorrowInTheSameBlock remainsSolvent {
        _stakeLpBeefy(IBeefyFinance.BeefyStakingDetails({
    ...
    **/
    function unstakePngUsdcAvaxLpBeefy(uint256 amount) public onlyOwnerOrInsolvent noBorrowInTheSameBlock nonReentrant {
    ...
    **/
    function unstakePngUsdceAvaxLpBeefy(uint256 amount) public onlyOwnerOrInsolvent noBorrowInTheSameBlock nonReentrant {
        _unstakeLpBeefy(IBeefyFinance.BeefyStakingDetails({
        lpTokenAddress: PNG_AVAX_USDCe_LP,
        vaultAddress: MOO_PNG_AVAX_USDCe_LP,
        lpTokenSymbol: "PNG_AVAX_USDCe_LP",
    ...
    **/
    function unstakeTjUsdcAvaxLpBeefy(uint256 amount) public onlyOwnerOrInsolvent noBorrowInTheSameBlock nonReentrant {
        _unstakeLpBeefy(IBeefyFinance.BeefyStakingDetails({
        lpTokenAddress: TJ_AVAX_USDC_LP,
        vaultAddress: MOO_TJ_AVAX_USDC_LP,
        lpTokenSymbol: "TJ_AVAX_USDC_LP",
    ...
    **/
    function _stakeLpBeefy(IBeefyFinance.BeefyStakingDetails memory stakingDetails) private notInLiquidation {
        ...
        require(_getAvailableBalance(tokenManager.tokenAddressToSymbol(stakingDetails.lpTokenAddress)) >= stakingDetails.amount, "Not enough LP token available");
