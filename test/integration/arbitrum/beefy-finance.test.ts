...
describe('Smart loan', () => {
    ...
    describe('A loan with staking tokens on BeefyFinance', () => {
        ...
        before("deploy factory and pool", async () => {
            ...
            await deployPools(smartLoansFactory, poolNameAirdropList, tokenContracts, poolContracts, lendingPools, owner, depositor, 1000, 'ARBITRUM', [], tokenManager.address);
        ...
        it("should swap and addLiquidity on Sushi", async () => {
            ...
            expect(await tokenContracts.get('GMX')!.balanceOf(wrappedLoan.address)).to.be.gt(0);
