...
export const deployAllFacets = async function (diamondAddress: any, mock: boolean = true, chain = 'AVAX',  hardhatConfig: any = undefined, provider: any = undefined) {
    ...
    if (chain == 'AVAX') {
        ...
        await deployFacet("SmartLoanWrappedNativeTokenFacet", diamondAddress, ['depositNativeToken', 'wrapNativeToken'], hardhatConfig)
        ...
        await deployFacet("SJoeFacet", diamondAddress, [
            "stakeJoe",
            "unstakeJoe",
            "claimSJoeRewards",
            "joeBalanceInSJoe",
        ...
        await deployFacet("PrimeLeverageFacet",diamondAddress, [
            "activatePremium",
            "stakePrimeAndActivatePremium",
            "deactivatePremiumTier",
            "stakePrime",
            "getPrimeStakedAmount",
            "unstakePrime",
            "updatePrimeDebt",
            "repayPrimeDebt",
            "getRequiredPrimeStake",
            "getLeverageTier",
            "getLeverageTierFullInfo",
            "shouldLiquidatePrimeDebt",
            "liquidatePrimeDebt",
          ],
          hardhatConfig);
