    ...
    for (const contract of deployedContracts) {
        ...
        try {
            await verifyContract(hre, {
                ...
                contract: `contracts/deployment/arbitrum/${contract.name}.sol:${contract.name}`,
        ...
        try {
            ...
            await tenderly.verify({
                address: contract.address,
                name: `contracts/deployment/arbitrum/${contract.name}.sol:${contract.name}`,
            });
...
module.exports.tags = ["arbitrum-pools-new"];