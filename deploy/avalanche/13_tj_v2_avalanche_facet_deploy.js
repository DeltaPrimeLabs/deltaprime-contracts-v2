...
module.exports = async ({ getNamedAccounts, deployments }) => {
    ...
    // Embed commit hash for TraderJoeV2AvalancheFacet
    embedCommitHash("TraderJoeV2AvalancheFacet", "./contracts/facets/avalanche");

    // Contracts to deploy
    const contractsToDeploy = [
        {
            name: "TraderJoeV2AvalancheFacet",
            contractPath: "contracts/facets/avalanche/TraderJoeV2AvalancheFacet.sol:TraderJoeV2AvalancheFacet",
            args: []
        }
    ];
