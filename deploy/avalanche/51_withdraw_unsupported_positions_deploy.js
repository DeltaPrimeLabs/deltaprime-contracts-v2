...
module.exports = async ({ getNamedAccounts, deployments }) => {
    ...
    // Embed commit hash for WithdrawUnsupportedPositionsFacet
    embedCommitHash("WithdrawUnsupportedPositionsFacet", "./contracts/facets");

    // Contracts to deploy
    const contractsToDeploy = [
        {
            name: "WithdrawUnsupportedPositionsFacet",
            contractPath: "contracts/facets/WithdrawUnsupportedPositionsFacet.sol:WithdrawUnsupportedPositionsFacet",
            args: []
        }
    ];
...
module.exports.tags = ["avalanche-withdraw-unsupported-positions-facet"];