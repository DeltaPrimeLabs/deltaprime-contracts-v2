...
module.exports = async ({ getNamedAccounts, deployments }) => {
    ...
    // Embed commit hash for SJoeFacet
    embedCommitHash("SJoeFacet", "./contracts/facets");

    // Contracts to deploy
    const contractsToDeploy = [
        {
            name: "SJoeFacet",
            contractPath: "contracts/facets/SJoeFacet.sol:SJoeFacet",
            args: []
        }
    ];
...
module.exports.tags = ["avalanche-sjoe-facet"];